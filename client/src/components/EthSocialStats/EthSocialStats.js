...
import './EthSocialStats.css'

const EthSocialStats = () => {

    const url = `https://min-api.cryptocompare.com/data/social/coin/latest?coinId=7605&api_key=${process.env.REACT_APP_CRYPTOCOMPARE_API_KEY}`
    ...
    return (
        <Box className='ethStats-box' marginTop='30px'>
            <Card maxWidth='250px' color='#f4f4f4' backgroundColor='#26272b'>
                <CardHeader>
                    <Heading size='md'>Ethereum Social Stats</Heading>
                </CardHeader>
                <CardBody>
                    {isLoading ? (
                        <Center height="200px">
